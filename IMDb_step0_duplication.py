...
args = {
    ...
    'save_dir': 'DP_results/IMDb_step0_dp_trainer',                                   ##directory for saving models
...
def construct_training_eval(args,random_seed,num_per_example=7): 
    ...
    for key in train_keys:
        ...
        train_texts = train_texts + [origin_text]*(num_per_example+1)
        train_labels = train_labels + [label]*(num_per_example+1)
