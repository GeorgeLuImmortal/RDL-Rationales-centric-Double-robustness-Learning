...
args = {
    ...
    'save_dir': 'RR_results/IMDb_step0_rr_trainer',                                   ##directory for saving models
...
def construct_training_eval(args,random_seed,num_per_example=7): 
    ...
    with open("./datasets/IMDb/random_replace_examples_full.json", "r") as file_name:
        augmented_data = json.load(file_name)
                                   
    ## magnify with random replacement examples 
    train_texts = []
    train_labels = []
